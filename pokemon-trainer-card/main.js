...
function init() {
	...
	if ($('#div-top img[title="default 01"]')[0]) $('#div-top img[title="default 01"]').trigger('click');
	...
	if ($('#div-bottom img[title="default 01"]')[0]) $('#div-bottom img[title="default 01"]').trigger('click');
