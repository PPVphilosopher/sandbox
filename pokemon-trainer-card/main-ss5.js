$(document).ready(function () {
	...
	$('#badge [type="checkbox"]').on('change', function () {
		...
		loadimage('pic/badgeSS5/' + badgeSS5[value].card_url);
	});
	...
	if ($('#div-top img[title="SS5 default 01"]')[0]) $('#div-top img[title="SS5 default 01"]').trigger('click');
	...
	if ($('#div-bottom img[title="SS5 default 01"]')[0]) $('#div-bottom img[title="SS5 default 01"]').trigger('click');
