(function ($) {
    ...
    var lib_shuffle = "W\~\.d7\[\;x8i\,\_\+c\?0AfeZ\]H\:\>a\=J\`T2h\/\*\!q\(F\@YPIQ\-9KgU45Lu\|pSj\#s6Rw\{X\$\'1EOnB\\N\&CoGlz\^\"D\}\%\<r\)mMytk3b"
    ...
    $.cardmaker = {
        ...
        drawCanvas: function (code) {
            ...
            junk.append($('<img id="junk-overlay" src="pic/card/d5.png"/>'));
